...
const Footer = () => {
  return (
    <div className="px-32 h-screen flex flex-col bg-[#0D1321] text-white">
      ...
      <div>
        ...
        <div>
          <p>Elevate Your Business with RegisterKaro</p>
        ...
        <div>
          <p>Navigating Regulatory Affairs</p>
        ...
        <div>
          <p>Business Registration Expertise</p>
        ...
        <div>
          <p>Safeguarding Intellectual Property</p>
